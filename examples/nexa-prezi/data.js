export const FRAMES = [
  ...
  },
  {
    ...
    data: {
      ...
      eyebrow: "Add-ons",
      icon: "bi-node-plus",
      heading: "Canvas, Prezi e editor no mesmo pacote",
      body: "Alem do core, Nexa inclui extensoes para experiencias ricas sem build: editor de pipeline SVG, palco Prezi com camera animada e editor CodeMirror.",
      items: ["PipelineCanvasController", "PreziStage", "FullCodeEditor + snippets"],
    },
  },
  {
    id: "codigo",
  ...
  },
  {
    ...
    data: {
      ...
      columns: [
        ...
        {
          title: "Para expandir",
          items: ["Biblioteca de componentes", "PreziStage para apresentacoes", "Canvas e editor como add-ons"],
        },
      ],
    },
  },
