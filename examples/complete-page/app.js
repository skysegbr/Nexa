...
import { projects, statusOptions, views } from "./data.js";
      ...
      h(
        ...
        h(Card, { className: "filters-card" },
          ...
          h("div", { className: "filters-grid" },
            ...
            h(Select, { id: "status", label: "Status", options: statusOptions, value: status, onChange: (e) => setStatus(e.target.value) }),
          ),
        ),
